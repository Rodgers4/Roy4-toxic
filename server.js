  ...
  try {
    ...
    if (customReply) {
      ...
      const { data } = await axios.get(
        "https://api.princetechn.com/api/princegpt",
        {
          params: { apikey: "prince", query: ask },
        }
      );
      replyText = data?.response || "I couldn't get a reply right now.";
    }

    const finalResponse = `LORNA\n${replyText}\n━━━━━━━━━━━━━━━\nPOWERED BY ROYTECH`;
